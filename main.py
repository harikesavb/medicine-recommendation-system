...
sym_des = pd.read_csv("d:\Harikesava\Medical-Recommendation-System\dataset\symptoms_df.csv")
precautions = pd.read_csv("d:\Harikesava\Medical-Recommendation-System\dataset\precautions_df.csv")
workout = pd.read_csv("d:\Harikesava\Medical-Recommendation-System\dataset\workout_df.csv")
description = pd.read_csv("d:\Harikesava\Medical-Recommendation-System\dataset\description.csv")
medications = pd.read_csv('d:\Harikesava\Medical-Recommendation-System\dataset\medications.csv')
diets = pd.read_csv("d:\Harikesava\Medical-Recommendation-System\dataset\diets.csv")

Rf = pickle.load(open('d:\Harikesava\Medical-Recommendation-System\model\RandomForest.pkl','rb'))
